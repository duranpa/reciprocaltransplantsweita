...
gnoto %>%
  ...
  lmer(formula = fruits_per_seedling ~ 
         plants_per_block + (1 | tub) +
         (1 | Climate) + (1 | geno) + (1| Soil) + (1 | Tea) +
         (1 | Climate : geno) + (1 | Climate : Soil) + (1 | Climate : Tea) +
         (1 | geno : Soil) + (1 | geno : Tea) +
         (1 | Soil : Tea) +
         (1 | Climate : geno : Soil) + (1 | Climate : geno : Tea) + (1 | Tea : geno : Soil) +
         (1 | Climate : geno : Soil : Tea)
       ) %>%
  summary
...
gnoto %>%
  # mutate(r = paste0(geno, Soil, Tea)) %>% 
  filter(Soil %in% c("Italy", "Sweden"), Tea %in% c("Italy", "Sweden"), Sterile == 1) %>%
  aov(
  formula = 
    fruits_per_seedling ~ Climate * geno * Soil * Tea + Error(Climate/tub)
) %>% summary()
...
gnoto %>%
  ...
  aov(
  formula = 
    fruits_per_seedling ~ Climate * geno * Soil * Tea + plants_per_block + Error(r) 
) %>% summary()
...
gnoto %>%
  ...
  aov(
  formula = 
    fruits_per_seedling ~ Climate * geno * Soil + plants_per_block + Error(Climate/tub)
) %>% summary()
```
